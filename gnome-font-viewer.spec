...
Version  : 3.20.2
Release  : 1
URL      : https://download.gnome.org/core/3.20/3.20.2/sources/gnome-font-viewer-3.20.2.tar.xz
Source0  : https://download.gnome.org/core/3.20/3.20.2/sources/gnome-font-viewer-3.20.2.tar.xz
...
%prep
%setup -q -n gnome-font-viewer-3.20.2
