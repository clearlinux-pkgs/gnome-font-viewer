...
Source0  : https://download.gnome.org/sources/gnome-font-viewer/46/gnome-font-viewer-46.0.tar.xz
...
%prep
%setup -q -n gnome-font-viewer-46.0
cd %{_builddir}/gnome-font-viewer-46.0
pushd ..
cp -a gnome-font-viewer-46.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711378117
