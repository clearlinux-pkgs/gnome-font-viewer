...
Source0  : https://download.gnome.org/sources/gnome-font-viewer/41/gnome-font-viewer-41.0.tar.xz
...
%prep
%setup -q -n gnome-font-viewer-41.0
cd %{_builddir}/gnome-font-viewer-41.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632415810
...
cp %{_builddir}/gnome-font-viewer-41.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-font-viewer/dfac199a7539a404407098a2541b9482279f690d
