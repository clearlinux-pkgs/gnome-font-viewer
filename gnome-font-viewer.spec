...
Version  : 45.0
Release  : 33
URL      : https://download.gnome.org/sources/gnome-font-viewer/45/gnome-font-viewer-45.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-font-viewer/45/gnome-font-viewer-45.0.tar.xz
...
%prep
%setup -q -n gnome-font-viewer-45.0
cd %{_builddir}/gnome-font-viewer-45.0
pushd ..
cp -a gnome-font-viewer-45.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695681510
