...
Source0  : https://download.gnome.org/sources/gnome-font-viewer/3.33/gnome-font-viewer-3.33.90.tar.xz
...
%prep
%setup -q -n gnome-font-viewer-3.33.90
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568123692
