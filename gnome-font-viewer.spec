...
Version  : 40.0
Release  : 24
URL      : https://download.gnome.org/sources/gnome-font-viewer/40/gnome-font-viewer-40.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-font-viewer/40/gnome-font-viewer-40.0.tar.xz
...
%prep
%setup -q -n gnome-font-viewer-40.0
cd %{_builddir}/gnome-font-viewer-40.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619127191
...
cp %{_builddir}/gnome-font-viewer-40.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-font-viewer/dfac199a7539a404407098a2541b9482279f690d
